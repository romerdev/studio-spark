...
<img class="masthead" src="<?php echo site_url('/images/mast/mast-image-about.jpg') ?>" alt="Card image cap">
...
<section class="container py-3">
    <div class="row">
        <div class="col-lg-6 py-3">
            ...
            <p>Een groep van 2 mediavormgevers en 2 mediadevelopers. Bij elkaar gebracht door het <a href="https://www.ma-web.nl/" target="_blank">Mediacollege Amsterdam</a>. Wat eerst als onbekenden tot elkaar begon, werd al snel een waardig team, klaar om het tot uiterste  te gaan.</p>
        </div>
        <div class="col-lg-6 py-3">
            <h2>Onze waarden</h2>
            <br>
...
<section class="container pb-5">
    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            <img class="w-100 py-2" src="<?php echo site_url('/images/about/bram-bollen.png') ?>" alt="Card image cap">
        </div>
    </div>
    <hr class="pb-3">
    <div class="row">
    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            <img class="w-100 py-2" src="<?php echo site_url('/images/about/romer-bollen.png') ?>" alt="Card image cap">
        </div>
    </div>
</section>